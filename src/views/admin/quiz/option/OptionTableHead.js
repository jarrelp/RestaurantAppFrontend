...
const OptionTableHead = ({ quizId, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, selected, headCells }) => {
            ...
            <TableRow>
                ...
                {numSelected > 0 && (
                    <TableCell padding="none" colSpan={7}>
                        <OptionHeaderTableToolbar quizId={quizId} selected={selected} />
                    </TableCell>
                )}
                {numSelected <= 0 &&
